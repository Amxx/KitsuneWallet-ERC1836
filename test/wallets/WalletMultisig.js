...
describe('Wallet', () => {
	...
	testExecute      (provider, 'execute(uint256,address,uint256,bytes,uint256,bytes[])');
	testKeyManagement(provider, 'execute(uint256,address,uint256,bytes,uint256,bytes[])');
	testMultisig     (provider, 'execute(uint256,address,uint256,bytes,uint256,bytes[])');
	testUpdateMaster (provider, 'execute(uint256,address,uint256,bytes,uint256,bytes[])');
