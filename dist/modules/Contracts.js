...
var Contracts = /** @class */ (function (_super) {
    ...
    Contracts.prototype.viewContract = function (name, address) {
        return new ethers_1.ethers.Contract(address, this.sdk.ABIS[name].abi, this.sdk.provider);
    };
    Contracts.prototype.deployContract = function (name, args, config) {
        ...
        return new Promise(function (resolve, reject) {
            var _a;
            (_a = (new ethers_1.ethers.ContractFactory(_this.sdk.ABIS[name].abi, _this.sdk.ABIS[name].bytecode, config['wallet'] || _this.sdk.wallet || reject(Error("Missing wallet"))))).deploy.apply(_a, args).then(function (instance) { return instance.deployed()
